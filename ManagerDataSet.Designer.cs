...
namespace Manager {
    ...
    public partial class ManagerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(int Id, string login, string tel, string email, string comments) {
            ...
            public string comments {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'comments\' в таблице \'Customers\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Manager.ManagerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([login] = @Origin" +
                "al_login) AND ([tel] = @Original_tel) AND ((@IsNull_email = 1 AND [email] IS NUL" +
                "L) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Id], [login], [tel], [email], [comments]) VALUES " +
                "(@Id, @login, @tel, @email, @comments);\r\nSELECT Id, login, tel, email, comments " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Id] = @Id, [login] = @login, [tel] = @tel, [email] = @email, [comments] = @comments WHERE (([Id] = @Original_Id) AND ([login] = @Original_login) AND ([tel] = @Original_tel) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT Id, login, tel, email, comments FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\Manager.mdf;I" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, login, tel, email, comments FROM dbo.Customers";
        ...
        public virtual int Fill(ManagerDataSet.CustomersDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ManagerDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_login, string Original_tel, string Original_email) {
        ...
        public virtual int Insert(int Id, string login, string tel, string email, string comments) {
        ...
        public virtual int Update(int Id, string login, string tel, string email, string comments, int Original_Id, string Original_login, string Original_tel, string Original_email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string tel, string email, string comments, int Original_Id, string Original_login, string Original_tel, string Original_email) {
            return this.Update(Original_Id, login, tel, email, comments, Original_Id, Original_login, Original_tel, Original_email);
        }
    }
